namespace RealEstate.Domain.Tests.Entities
{
	public class AddressTests
	{
        ...
        [Fact]
        public void When_Attach_Url_With_Valid_Url_Should_Return_Success()
        {
            // Arrange
            var url = "https://www.google.com";
            var addressName = "Test Address";
            ...
            // Act
            address.AttachUrl(newUrl);

            // Assert
            address.Url.Should().Be(newUrl);
        }

        [Fact]
        public void When_Attach_Url_With_Empty_Url_Should_Return_Success()
        {
            // Arrange
            var url = "https://www.google.com";
            var addressName = "Test Address";
